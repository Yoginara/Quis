          ...
          <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
            ...
            <div class="card shadow-lg">
              <div class="card-body p-5">
                <h1 class="fs-4 card-title fw-bold mb-4">Tambah Data Pegawai</h1>
                <form  action="" method="post" class="needs-validation" >
                  <div class="mb-3">
                    <label class="mb-2 text-muted" for="Nomor_Identitas">Nomor Induk :</label>
                    <input id="Nomor_Identitas" type="text" class="form-control" name="Nomor_Identitas"/>
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input id="Tempat_dan_Tanggal_Lahir" type="text" class="form-control" name="Tempat_dan_Tanggal_Lahir" />
                  </div>
                  <div class="mb-3">
